...
class ProfileUpdate extends StatefulWidget {
  final User secouriste;
  const ProfileUpdate({required this.secouriste});
        ...
        child: GestureDetector(
          ...
          child: ListView(
            children: [
              ...
              buildTextField("Nom", 'nom', namecontroller),
              ...
              buildTextField("Num", 'Num', phonecontroller),
              buildTextField("Age", 'age', agecontroller),
              buildTextField(
                  "Gouvernorat", 'gouvernorat', gouvernoratcontroller),
              SizedBox(
                height: 35,
              ),
              Row(
